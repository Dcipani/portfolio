        ...
        {cards.map((card, index) => (
          ...
          >
            <svg viewBox="0 0 185 185"> 
              <path fill={card.fill} d={card.path} transform="translate(100 100) scale(1, 1.5)" /> 
            </svg>
